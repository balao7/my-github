...
public class SearchActivity extends AppCompatActivity implements Runnable, ReposFragment.ReposFragmentCallback {
    public final int TIME_BETWEEN_TYPING_MS = 450;
    /**
     * Search query
     */
    private String mQuery = "ericn37";

    @BindView(R.id.searchview)
    SearchView searchView;
    @BindView(R.id.progressbar)
    ProgressBar progressBar;
    private ReposFragment mFrag;
    ...
    private void render() {
        ...
        mFrag = ReposFragment.newInstance(mQuery);
